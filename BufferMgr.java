...
/**
* since this class is wrapper to basicBufferMgr
* we have made changes to all those function that has been changed in basicBufferMgr
...
public class BufferMgr {
   ...
   //---------------------------------------
   /*
     As initial values are assigned to bufferPoolMap, we call this methods to remove those
     garbage values
 
   */
   public void printAppearance()
   {
	   bufferMgr.printAppearance();
   }
   ...
   public synchronized void unpin(Block blk) {
	   unpin(bufferMgr.unpin(blk));
   }
