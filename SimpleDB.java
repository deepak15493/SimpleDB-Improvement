...
public class SimpleDB {
   ...
   // Changed the signature of this fumction in order to get the BufferMgr instance in FindMajors
   public static BufferMgr init(String dirname) {
      BufferMgr buff= initFileLogAndBufferMgr(dirname);
    ...
    * @param dirname the name of the database directory
    */
   public static BufferMgr initFileLogAndBufferMgr(String dirname) {
